...
<br>
Find the materials at: [pos.it/quarto-brand-conf25](pos.it/quarto-brand-conf25)

## **Branded Websites, Presentations, Dashboards, and PDFs with Quarto**
<br>
**Make sure to:**

1. Install [Quarto 1.8](https://quarto.org/docs/get-started/)
2. Join Discord: From the [event portal](https://reg.conf.posit.co/flow/posit/positconf25/reg/login), click "Join the server", find our channel: #workshop-quarto-brand

::: notes
Intro: 30 min your turn
15 minute live coding
45 min talking

welcome to 
I have the wifi
I recommend opening the website on your own computer so you can follow along
:::
...
* The Code of Conduct can be found at [https://posit.co/code-of-conduct](https://posit.co/code-of-conduct). You can report Code of Conduct violations in person, by email, or by phone. Please see the policy linked above for contact information.

## Discord

From the [event portal](https://reg.conf.posit.co/flow/posit/positconf25/reg/login), click "Join the server", find our channel: #workshop-quarto-brand
...
![](images/gordon.png){fig-alt="Isabella's headshot" fig-align="center" width=250px style="border-radius: 50%;"}
...
![](images/christophe.jpg){fig-alt="Isabella's headshot" fig-align="center" width=250px style="border-radius: 50%;"}

<center>
**Christophe Dervieux**
Software Engineer,<br>R Markdown and Quarto
...
* Ask in the Discord channel: [#workshop-quarto-brand](https://discord.com/channels/1381993558437007490/1402378754084573299)

## Your turn - About you {background-color='{{< brand color light-blue >}}'}
...
# Introduction to Quarto {background-color='{{< brand color dark-blue >}}'}
...
::: notes
Let's see some examples of how people have used Quarto. Andrew Heiss, in conjunction with the Idaho Secretary of State's office, created a Quarto website for Idaho's primary election results.
:::
...
::: column
![](images/report-final.png){fig-align="center" width="100%" style="box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.3); border-radius: 5px;"}
:::
...
::: notes
world happiness report combines and analyzes wellbeing data for around 150 countries and writes an annual report. they investigate how happy countries are, how that happiness has changed over time, and what factors explain a country's happiness or lack thereof.

today, you're going to make reports, dashboards, websites, and presentations with this data.
:::
...
Quarto sits inside the broad literate programming world, which mixes narrative in text form with code for formatted outputs like documents and webpages and more. There are lots of literate programming systems that support computation, like R Markdown, Org Mode, Jupyter Book, and now there is Quarto!
:::
...
## Environment options {background-color='{{< brand color dark-blue >}}'}

Let's walk through your options for today.

::: incremental
1. Posit Cloud - RStudio
2. GitHub Codespace - VS Code
...
<center>[pos.it/quarto-brand-conf25](pos.it/quarto-brand-conf25)</center>
...
Positron/vs code insert code cell, cmd shift i
RStudio green button, cmd option i
::: 

# Quarto documents {background-color='{{< brand color dark-blue >}}'}
...
# Authoring Quarto {background-color='{{< brand color dark-blue >}}'}
...
+------------------------------------+---------------------------------+
|     ![](earth.jpg)                 | ![](images/earth.jpg){width=300} |
+------------------------------------+---------------------------------+
...
![](images/revealjs.png){fig-align="left"}
...
# Theme with brand.yml {background-color='{{< brand color dark-blue >}}'}
...
::: notes
you'll see an example of this during the presentations section
:::
