...
1. Installed [Quarto 1.8](https://quarto.org/docs/get-started/)
2. Joined Discord: [event portal](https://reg.conf.posit.co/flow/posit/positconf25/reg/login) > "Join the server" > #workshop-quarto-brand
