...
[{{< fa brands bluesky >}} @sara-altman.bsky.social](https://bsky.app/profile/sara-altman.bsky.social)
...
## Your turn {background-color='{{< brand color dark-blue >}}'}
...
## Your turn  {background-color='{{< brand color dark-blue >}}' .smaller}
...
![](images/whr.png){fig-align="center" width="40%" style="box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.3); border-radius: 5px;"}
...
If your brand file lives somewhere else, use the `brand` key to supply a file path.

```{.yaml code-line-numbers="5" filename="_brand.yml"}
---
title: "World Happiness Report"
subtitle: "Happiness Trends and Contributing Factors (2011-2024)"
format: html
brand: ../brand-files/whr.yml
---
```
...
![](images/brand-applied.png){fig-align="center" width="70%" style="box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.3); border-radius: 5px;"}

## Specify light and dark themes for documents

You can also specify a light and dark brand for documents. 
...
::: notes
create separate brand files
:::

## What about plots?

![](images/plot-unbranded.png){fig-align="center" width="70%" style="box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.3); border-radius: 5px;"}
...
Or access and apply specific brand elements. 
