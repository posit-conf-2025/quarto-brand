...
<!-- TODO: update images to use happiness data--> 
::::: columns
:::: {.column width="40%"}
...
<!-- TODO: update with relevant photo --> 
...
<!-- TODO: update with actual reports --> 
...
![](../../images/logo.png){fig-align="center" width="40%" style="box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.3); border-radius: 5px;"}
