...
::: aside
You can also `git clone` or download from GitHub: [github.com/skaltman/whr-website-template](github.com/skaltman/whr-website-template)
:::
...
[Quick start guide](https://quarto.org/docs/websites/#quick-start)
